...
export default function BookingConfirmation() {
  ...
  const [loading, setLoading] = useState(
    !(location.state?.booking && location.state?.product),
  );
  ...
  return (
    <div className="bg-gray-100 min-h-screen py-10">
      <div className="max-w-4xl mx-auto px-4 space-y-6">
        ...
        {loading && (
          <p className="text-gray-600">Preparing your reservation details…</p>
        )}
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  ...
                  <p className="text-gray-700">{product?.name ?? "Product"}</p>
              ...
              <p className="text-xs text-gray-500">
                We have sent a confirmation email with all the reservation
                details. If you need to make changes, head over to “My
                bookings”.
              </p>
            </div>
          </div>
